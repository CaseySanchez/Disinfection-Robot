...
public:
    ...
    void update() override
    {
        ...
        std::array<int32_t, 4> duty_cycle = {
            std::static_cast<int32_t>(std::abs(m_motor_speed[0]) * 100.0f),
            std::static_cast<int32_t>(std::abs(m_motor_speed[1]) * 100.0f),
            std::static_cast<int32_t>(std::abs(m_motor_speed[2]) * 100.0f),
            std::static_cast<int32_t>(std::abs(m_motor_speed[3]) * 100.0f)
        };
